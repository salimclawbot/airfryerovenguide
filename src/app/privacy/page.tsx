export const metadata = { title: "Privacy Policy", alternates: { canonical: "https://airfryerzone.com/privacy" } };
...
export default function PrivacyPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-4">
      ...
      <p>Air Fryer Zone (&quot;we,&quot; &quot;us,&quot; or &quot;our&quot;) operates this website. This policy explains how we collect, use, and protect your information.</p>
      ...
      <p>Email: <a className="text-blue-700 underline" href="mailto:privacy@Air Fryer Zone">privacy@Air Fryer Zone</a></p>
    </div>
  );
}
