export const metadata = { title: "Affiliate Disclosure", alternates: { canonical: "https://airfryerzone.com/affiliate-disclosure" } };
...
export default function AffiliateDisclosurePage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-4">
      ...
      <p>
        Air Fryer Zone is reader-supported. We may earn a commission when you buy through certain links on this site.
      ...
      <p>Email: <a className="text-blue-700 underline" href="mailto:editorial@Air Fryer Zone">editorial@Air Fryer Zone</a></p>
    </div>
  );
}
