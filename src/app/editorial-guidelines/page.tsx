export const metadata = { title: "Editorial Guidelines | Air Fryer Zone" };

export default function EditorialGuidelinesPage() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-10 space-y-6">
      <h1 className="text-3xl font-bold">Editorial Guidelines</h1>
      <p className="text-lg text-gray-600">How we research, write, and review content at Air Fryer Zone.</p>

      <section className="space-y-3">
        <h2 className="text-2xl font-semibold">Our Commitment to Accuracy</h2>
        <p>Every guide and review published on Air Fryer Zone is thoroughly researched before publication. Our writers draw on peer-reviewed research, expert interviews, and hands-on product testing to ensure the information we provide about air fryer cooking and recipes is accurate, up-to-date, and genuinely useful.</p>
      </section>
      ...
      <p><a href="/" className="text-blue-600 hover:underline">← Back to Air Fryer Zone</a></p>
    </div>
  );
}
