---
title: "Air Fryer Temperature Guide: Settings for Every Food (2026)"
slug: air-fryer-temperature-guide
meta_description: "Complete air fryer temperature guide for 2026. Find the perfect settings for chicken, fries, vegetables, fish, and more with our easy-to-follow cooking charts."
author: "Chef Maria Santos, Culinary Writer"
...
faq_schema:
  ...
  mainEntity:
    - "@type": "Question"
      name: "What temperature should I set my air fryer to for chicken?"
      acceptedAnswer:
        "@type": "Answer"
        text: "For bone-in chicken pieces, set your air fryer to 380°F (193°C) and cook for 20-25 minutes, flipping halfway through. Boneless chicken breasts cook best at 375°F (190°C) for 12-15 minutes. Chicken wings are crispiest at 400°F (204°C) for 20-24 minutes. Always verify the internal temperature reaches 165°F (74°C) with a meat thermometer before serving."
    - "@type": "Question"
      name: "Do I need to preheat my air fryer?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Yes, preheating your air fryer for 3-5 minutes at the desired cooking temperature is recommended for most foods. Preheating ensures even cooking and helps achieve a crispier exterior. Some newer models have automatic preheat cycles. The main exceptions are delicate items like pastries or foods with wet batter, which can be placed in a cold air fryer to prevent dripping."
    - "@type": "Question"
      name: "Why is my air fryer food not crispy?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The most common reasons air fryer food lacks crispiness are overcrowding the basket, cooking at too low a temperature, not using enough oil, and excess moisture on the food. To fix this, cook in single layers with space between items, increase the temperature by 10-15°F, lightly spray food with oil, and pat items dry with paper towels before cooking. Shaking or flipping food halfway through also promotes even browning."
    - "@type": "Question"
      name: "How do I convert oven recipes to air fryer temperatures?"
      acceptedAnswer:
        "@type": "Answer"
        text: "The general rule for converting oven recipes to air fryer settings is to reduce the temperature by 25°F (about 14°C) and cut the cooking time by 20-25%. For example, a recipe calling for 400°F in a conventional oven would translate to 375°F in an air fryer. Because air fryers circulate hot air more efficiently than standard ovens, food cooks faster and at lower temperatures while still achieving the same results."
    - "@type": "Question"
      name: "What foods should you not cook in an air fryer?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Avoid cooking foods with wet batter (like beer-battered fish) as the batter drips through the basket before setting. Large roasts that fill the entire basket won't cook evenly due to restricted airflow. Leafy greens like spinach or kale can blow around and burn. Cheese-heavy dishes tend to melt and create a mess. Raw grains and pasta require boiling water, which air fryers cannot provide. For these items, stick to your conventional oven or stovetop."
    - "@type": "Question"
      name: "Is it safe to use aluminum foil in an air fryer?"
      acceptedAnswer:
        "@type": "Answer"
        text: "Yes, aluminum foil is safe to use in most air fryers as long as you follow a few guidelines. Always place foil in the basket, never covering the entire bottom as it can block airflow. Weigh it down with food so it doesn't blow into the heating element. Never use foil with acidic foods like tomatoes or citrus, as the acid can cause the foil to break down. Parchment paper with pre-cut holes designed for air fryers is often a better alternative."
article_schema:
  "@context": "https://schema.org"
  "@type": "Article"
  headline: "Air Fryer Temperature Guide: Settings for Every Food (2026)"
  author:
    "@type": "Person"
  ...
  publisher:
    ...
    url: "https://officechairpicks.vercel.app"
  description: "Complete air fryer temperature guide for 2026. Find the perfect settings for chicken, fries, vegetables, fish, and more with our easy-to-follow cooking charts."
  mainEntityOfPage:
    "@type": "WebPage"
    "@id": "https://officechairpicks.vercel.app/air-fryer-temperature-guide"
---
...
- [How Air Fryer Temperatures Work](#how-air-fryer-temperatures-work)
- [Oven-to-Air-Fryer Conversion Rule](#oven-to-air-fryer-conversion-rule)
- [Complete Air Fryer Temperature Chart by Food](#complete-air-fryer-temperature-chart-by-food)
- [Poultry Temperature Guide](#poultry-temperature-guide)
- [Beef, Pork, and Lamb Settings](#beef-pork-and-lamb-settings)
- [Seafood and Fish Temperature Guide](#seafood-and-fish-temperature-guide)
- [Vegetable Air Frying Temperatures](#vegetable-air-frying-temperatures)
- [Frozen Foods Quick Reference](#frozen-foods-quick-reference)
- [Baked Goods and Desserts](#baked-goods-and-desserts)
- [Common Air Fryer Temperature Mistakes](#common-air-fryer-temperature-mistakes)
- [Tips for Perfect Results Every Time](#tips-for-perfect-results-every-time)
- [FAQ](#faq)
...
![Air fryer temperature dial showing common cooking ranges for different food categories](/images/air-fryer-temperature-guide/temperature-dial-ranges.jpg)
...
![Perfectly seared air fryer steak with grill marks resting on a cutting board with a meat thermometer showing 135 degrees](/images/air-fryer-temperature-guide/air-fryer-steak-thermometer.jpg)
...
![Golden crispy air fryer french fries in a basket lined with parchment paper next to a small bowl of ketchup](/images/air-fryer-temperature-guide/crispy-air-fryer-fries.jpg)
...
1. **Invest in a digital meat thermometer.** It removes all guesswork from protein cooking and costs under $15. This is the single best accessory for air fryer cooking.

2. **Use parchment liners with pre-cut holes.** They prevent sticking, make cleanup effortless, and allow airflow to continue circulating properly. Available at most grocery stores.

3. **Mist with oil using a spray bottle.** Aerosol cooking sprays contain propellants that can damage non-stick coatings over time. Fill a reusable spray bottle with avocado oil for a healthier, safer option.

4. **Pull the basket out to check food — it won't reset the timer.** Unlike an oven where opening the door drops the temperature significantly, the air fryer's small chamber recovers heat almost instantly.

5. **Let the air fryer cool slightly between batches.** If cooking multiple rounds, give it 1-2 minutes between batches to prevent the exterior of food from burning before the interior cooks through.

6. **Keep your air fryer clean.** Grease buildup causes smoking and off-flavors. Wipe down the basket after every use and deep-clean the heating element monthly.
...
![Air fryer basket with crispy chicken wings showing golden-brown colour at 200°C](/images/air-fryer-temperature-guide/crispy-chicken-wings-200c.jpg)

![Infographic: Air Fryer Temperature Chart for Every Food Type — chicken, fish, veg, frozen foods](/images/air-fryer-temperature-guide/temperature-chart-infographic.png)

### Watch: Air fryer temperature guide — settings for every food

▶ [Air fryer temperature guide — settings for every food](https://www.youtube.com/watch?v=PLACEHOLDER_AF)
